...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $('body').on('click', '.editData', function () {
      ...
      $.get("{{ route('manageaddon.index') }}" +'/' + data_id +'/edit', function (data) {
        ...
        swal({
          ...
          icon: 'success'
            ...
            $.ajax({
                ...
                url: "{{ route('manageaddon.store') }}"+'/'+data_id,
