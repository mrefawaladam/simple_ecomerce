...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $('body').on('click', '.editData', function () {
      ...
      $.get("{{ route('managemenu.index') }}" +'/' + data_id +'/edit', function (data) {
        ...
        swal({
          ...
          icon: 'success'
            ...
            $.ajax({
                ...
                url: "{{ route('managemenu.store') }}"+'/'+data_id,
