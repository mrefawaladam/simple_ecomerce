            ...
            <div class="content-detached content-right">
                <div class="content-body">
                    ...
                    <section id="ecommerce-products" class="grid-view">
                        ...
                        @foreach($ingredientes as $m)
                        <div class="card ecommerce-card">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img class="img-fluid card-img-top" src="{{ asset('foto/'.$m->file_ingredients) }}" alt="img-placeholder" /></a>
                            </div>
                            <div class="card-body">
                                <h6 class="item-name">
                            ...
                            <div class="item-options text-center">
                                ...
                                <a href="javascript:void(0);"  data-id="{{ $m->id_ingredients}}" class="btn btn-primary pilihData btn-cart">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="clear-filters">
                                    <a href="{{ url('addon')  }}"class="btn btn-block btn-success">Add on</a>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $('body').on('click', '.pilihData', function () {

      var data_id = $(this).data('id');

      $.get("{{ url('ingredientes/add') }}" +'/' + data_id , function (data) {
