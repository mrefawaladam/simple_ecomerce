                        ...
                        <div class="card ecommerce-card">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img class="img-fluid card-img-top" src="{{ asset('foto/'.$m->file_add_on) }}" alt="img-placeholder" /></a>
                            </div>
                            <div class="card-body">
                                <h6 class="item-name">
                            ...
                            <div class="item-options text-center">
                                ...
                                <a href="javascript:void(0);"  data-id="{{ $m->id_add_on}}" class="btn btn-primary pilihData btn-cart">
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $('body').on('click', '.pilihData', function () {
      ...
      $.get("{{ url('addon/add') }}" +'/' + data_id , function (data) {
